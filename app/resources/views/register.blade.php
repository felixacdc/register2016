            ...
            <div class="col s12">
                {!! Form::open(['url' => 'register', 'method' => 'POST', 'class' => 'col s12', 'id' => 'formValidate']) !!}
                    ...
                    <div class="title-class col s6 offset-s3">
                        <h3 class="center white-text wow bounceInLeft">Registro</h3>
                        <hr style="border: .5px solid #fff;" class="scrollspy wow bounceInRight" id="register">
                    </div>
                    <div class="row">
                        <div class="input-field col s12 wow bounceInLeft">
                        ...
                        <div class="input-select col s12 wow bounceInLeft">
